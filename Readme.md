...
Transactions by Bank (Compares transaction volume across different banks)
Transactions by Branch (Identifies high and low performing branches based on activity)
